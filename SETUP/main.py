...
if __name__ == "__main__":
    try:
        ...
        segformer_output = f"{checkpoints_dir}/Segformer_ISIC2018_epoch_50_model.pth"
        ...
        segformer3D_output = f"{checkpoints_dir}/Segformer3D_BraTS2021_epoch_50_model.pth"
        ...
        unet2D_output = f"{checkpoints_dir}/Unet2D_ISIC2018_epoch_50_model.pth"
        ...
        unet3D_output = f"{checkpoints_dir}/Unet3D_BraTS2021_epoch_50_model.pth"
